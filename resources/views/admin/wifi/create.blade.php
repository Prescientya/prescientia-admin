...
<div class="card form-card">
    <div class="card-body">
        <h2 style="margin-top: 0; margin-bottom: 1.5rem;">➕ Tambah WiFi Baru</h2>
        ...
        <form action="{{ route('admin.wifi.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    required
                >
                <small class="form-text">Nama jaringan WiFi yang akan ditambahkan</small>
                @error('ssid')
            ...
            <div class="form-group">
                ...
                >
                <small class="form-text">IP Address router/gateway WiFi (opsional, bisa ditambahkan/diubah nanti)</small>
                @error('ip_address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group" style="margin-top: 2rem;">
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary">💾 Simpan WiFi</button>
