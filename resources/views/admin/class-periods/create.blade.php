        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Form Tambah Jam Pelajaran</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.class-periods.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="sequence" id="sequence" class="form-control @error('sequence') is-invalid @enderror" value="{{ old('sequence') }}" required min="1">
                            @error('sequence')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Opsional - akan dihitung otomatis jika dikosongkan</small>
                        </div>
