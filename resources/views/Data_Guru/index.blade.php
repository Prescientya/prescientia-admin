...
<div class="dg-page">
    ...
    <div class="dg-header">
        ...
        <div class="dg-header__actions">
            ...
            <button type="button" class="btn btn--danger" data-open-modal="modalDeleteAllTeachers">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
<div class="modal-overlay" id="modalDeleteAllTeachers">
    <div class="modal modal--sm">
        <div class="modal-header">
            <h2 class="modal-title modal-title--danger">Hapus Semua Data Guru</h2>
            <button type="button" class="modal-close-btn modal-close" aria-label="Tutup">&times;</button>
        </div>
        <div class="modal-body">
            <p>Anda akan menghapus <strong>{{ $teachers->total() }}</strong> data guru beserta akun login dan relasi mapelnya.</p>
            ...
            <div class="form-group" style="margin-top:1rem;">
                ...
                <input type="password" name="bulk_delete_password" form="deleteAllTeachersForm" class="form-control" autocomplete="current-password" required>
                @error('bulk_delete_password')
                    <div class="form-error">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group" style="margin-top:.85rem;">
                <label class="form-label">Ketik HAPUS SEMUA GURU <span class="req">*</span></label>
                <input type="text" name="bulk_delete_confirmation" form="deleteAllTeachersForm" class="form-control" placeholder="HAPUS SEMUA GURU" required>
        ...
        <div class="modal-footer">
            ...
            <form id="deleteAllTeachersForm" method="POST" action="{{ route('guru.destroy-all') }}" style="display:inline;">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn--danger">Ya, Hapus Semua Guru</button>
            </form>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.PSC) window.PSC.openModal('modalDeleteAllTeachers');
});
@endif
</script>
