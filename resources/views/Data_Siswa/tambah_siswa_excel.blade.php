        ...
        <div class="modal-header">
            <h3 class="modal-title">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                     ...
                     stroke-linecap="round" stroke-linejoin="round" style="display:inline;vertical-align:-3px;margin-right:6px;color:#059669;">
        ...
        <form action="{{ route('siswa.import') }}" method="POST" enctype="multipart/form-data" data-loading>
            ...
            <div class="modal-body">
                ...
                <div class="excel-dropzone" id="excelDropzone">
                    ...
                    <input type="file" id="excelFileInput" name="file"
                ...
                <div class="excel-file-chosen" id="excelFileChosen">
                    ...
                    <button type="button" class="excel-file-clear" id="excelFileClear" aria-label="Hapus file">
                ...
                <div class="excel-template-row">
                    ...
                    <p class="excel-template-txt">
                        Gunakan template kolom: <strong>nis, nama, email, password, gender (L/P), tanggal_lahir, no_hp, alamat, tingkat, jurusan</strong>.
                        Jika email kosong, otomatis: <em>nis@siswa.prescientia.id</em>.
                    </p>
                </div>
